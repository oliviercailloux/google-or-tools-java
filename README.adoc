...
This project contains no specific source code (except for a simple test). Everything comes from Google OR-Tools.

Here is how to re-make this project from scratch.
